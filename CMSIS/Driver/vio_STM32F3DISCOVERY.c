/******************************************************************************
 * @file     vio_STM32F3DISCOVERY.c
 * @brief    Virtual I/O implementation for board STM32F3DISCOVERY
 * @version  V1.0.0
...
/*! \page vio_STM32F3DISCOVERY Physical I/O Mapping
...
| vioLED0       | vioSignalOut.0 | LED red     (LD3)    | PE9
| vioLED1       | vioSignalOut.1 | LED green   (LD6)    | PE15
| vioLED2       | vioSignalOut.2 | LED blue    (LD4)    | PE8
| vioLED3       | vioSignalOut.3 | LED orange  (LD5)    | PE10
| vioLED0       | vioSignalOut.0 | LED green   (LD7)    | PE11
| vioLED1       | vioSignalOut.1 | LED orange  (LD8)    | PE14
| vioLED2       | vioSignalOut.2 | LED blue    (LD9)    | PE12
| vioLED3       | vioSignalOut.3 | LED red     (LD10)   | PE13
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTE(9),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED1,    GPIO_PIN_ID_PORTE(15), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED2,    GPIO_PIN_ID_PORTE(8),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED3,    GPIO_PIN_ID_PORTE(10), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED4,    GPIO_PIN_ID_PORTE(11), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED5,    GPIO_PIN_ID_PORTE(14), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED6,    GPIO_PIN_ID_PORTE(12), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED7,    GPIO_PIN_ID_PORTE(13), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH }
};
#endif
